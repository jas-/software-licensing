...
DROP DATABASE IF EXISTS `myTFH`;
CREATE DATABASE `myTFH`;

-- Create a default user and assign limited permissions
CREATE USER "myTFH"@"localhost" IDENTIFIED BY "p@ssw0rd";
GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES, INDEX, CREATE TEMPORARY TABLES, LOCK TABLES, EXECUTE ON `myTFH`.* TO "myTFH"@"localhost";
FLUSH PRIVILEGES;
