 ...
 <div id="form" class="rounder gradient">
  ...
  <form id="acl" name="acl" method="post" action="?nxs=proxy/acl">
   <label for="allow">Allow: </label>
    <textarea id="allow" name="allow" value="" placeholder="192.168.0.1, 10.10.0.0/24, 192.168.10.5-192.168.10.200" required="required"></textarea><span class="required">*</span><br />
   <label for="deny">Deny: </label>
    <textarea id="deny" name="deny" value="" placeholder="192.168.0.1, 10.10.0.0/24, 192.168.10.5-192.168.10.200" required="required"></textarea><span class="required">*</span><br />
   <label></label>
