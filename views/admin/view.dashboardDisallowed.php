...
class dashboardDisallowed
{
	...
	{
		$this->registry->tpl->assign('main', $this->registry->tpl->assign(null, null, 'disallowed.tpl', true, $this->registry->libs->_getRealIPv4()), null, null);
	}
